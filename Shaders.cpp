...
#include <learnopengl/shader_s.h>//包含目录D:\APP\VSIDE\VC\Tools\MSVC\14.32.31326\include中
...
//#endif
	...
	*/
	...
	//解释顶点数据 //增加顶点rgb后步长从3增加为6
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);
		//vetex color
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3* sizeof(float)));// 最后一个参数为偏移量
